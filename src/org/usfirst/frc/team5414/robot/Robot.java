...
import org.usfirst.frc.team5414.robot.commands.AutoBoilerDELAYED;
...
import org.usfirst.frc.team5414.robot.commands.AutoLoadingLaneDELAYED;
import org.usfirst.frc.team5414.robot.commands.AutoLoadingLaneGear;
import org.usfirst.frc.team5414.robot.commands.AutoMidDELAYED;
...
//	SendableChooser<CommandGroup> AutoChooser;
    ...
    String test="";
    UsbCamera cam1;
    static boolean autoShifted = false;
...
//		SmartDashboard.putData("Autonomous Mode", AutoChooser);
	...
	public void autonomousInit() {
		...
		case 3: autonomousCommand = new AutoBoilerDELAYED(); break;
		case 4: autonomousCommand = new AutoMidDELAYED(); break;
		case 5: autonomousCommand = new AutoLoadingLaneDELAYED(); break;
		case 6: autonomousCommand = new AutoShootStrafe(4, .9); break;
		case 7: autonomousCommand = new AutoDriveForward(10); break;
		case 8: autonomousCommand = new AutoShootOnly(); break;
		case 9: autonomousCommand = null; break;
		}
...
//		drivetrain.FullTraction();
		SmartDashboard.putNumber("Current RPM", shooter.currentRPM());
		SmartDashboard.putBoolean("isLimitSet", gearcollector.isLimitPressed());
		SmartDashboard.putNumber("Gear Arm", geararm.currentposition());
		maxSpeed = Math.max(maxSpeed, drivetrain.getSpeed());
		SmartDashboard.putNumber("Maximum Velocity", maxSpeed);
...
//		SmartDashboard.putNumber("Drivetrain Current", electrical.getDrivetrainCurrent());
//		if(electrical.getDrivetrainCurrent() >= RobotMap.ShiftCurrent && !autoShifted)
//		{
//			autoShifted = true;
//			drivetrain.FullTraction();
//		}
