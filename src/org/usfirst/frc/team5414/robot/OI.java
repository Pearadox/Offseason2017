...
import org.usfirst.frc.team5414.robot.commands.ShooterTriggerClose;
import org.usfirst.frc.team5414.robot.commands.ShooterTriggerOpen;
...
//		JoystickButton ToggleLight = new JoystickButton(stick, RobotMap.BtnLight);
		...
		} catch(Exception e) { System.out.println("Arduino not plugged in"); }
...
//		ActivateButterfly.whenPressed(new DriveForward());
		
		shoot.whenPressed(new ShootWhilePressed());
		shoot.whenReleased(new ShooterTriggerClose());
